...
class AccessToken extends AbstractAPI
{
    ...
    protected $container;
    protected $accessTokenCacheKey = 'sinre.IopenWechat.oauth_access_token.';
    protected $refreshTokenCacheKey = 'sinre.IopenWechat.oauth_refresh_token.';
     ...
     * @param array|\IopenWechat\Core\Collection $data access token 信息
     */
